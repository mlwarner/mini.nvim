...
---
--- `options.wrap` is a boolean indicating whether to wrap around edges during
...
MiniDiff.goto_hunk = function(direction, opts)
  ...
  local default_wrap = buf_cache.config.options.wrap
...
H.setup_config = function(config)
  ...
  vim.validate({
    ...
    ['options.wrap'] = { config.options.wrap, 'boolean' },
  })
