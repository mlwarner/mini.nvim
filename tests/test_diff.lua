...
T['setup()']['creates `config` field'] = function()
  ...
  expect_config('options.wrap', false)
end
...
T['setup()']['validates `config` argument'] = function()
  ...
  expect_config_error({ options = { wrap = 'a' } }, 'options.wrap', 'boolean')
end
...
T['goto_hunk()']['respects `opts.wrap`'] = function()
  -- Should use `config.options.wrap` as default value
  child.lua('MiniDiff.config.options.wrap = true')
...
T['Goto']['respects `options.wrap`'] = function()
  child.lua('MiniDiff.config.options.wrap = true')
